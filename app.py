...
with st.sidebar.expander("⚖️ Legal Disclaimer"):
    st.info("This project is proprietary.This application is for demonstration and educational purposes only.Unauthorized reproduction, redistribution, or commercial use is prohibited. Any external use or distribution without explicit permission is prohibited.")
